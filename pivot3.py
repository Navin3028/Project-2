...
def create_Slicer(pivot_table, field, slicer_name, top_left_cell, width_cm, height_cm):
    slicer_cache = wb.SlicerCaches.Add2(pivot_table, field)
    slicer = slicer_cache.Slicers.Add(pivot_ws, Name=slicer_name)
    slicer.Top = top_left_cell.Top
    slicer.Left = top_left_cell.Left
    
    slicer.Width = width_cm * 28.35  
    slicer.Height = height_cm * 28.35  
...
row_fields = ["Tag: BU", "Cloud", "Subscription", "Tag: Dept"]
value_field = "Cost"
...
slicer_specs = [
    {"field": "Cloud", "top_left_cell": pivot_ws.Cells(2, 1), "width_cm": 5.11, "height_cm": 2.1},
    {"field": "Subscription", "top_left_cell": pivot_ws.Cells(29, 1), "width_cm": 5.11, "height_cm": 10.37},
    {"field": "Tag: BU", "top_left_cell": pivot_ws.Cells(7, 1), "width_cm": 5.18, "height_cm": 11.04},
    {"field": "Tag: Owner", "top_left_cell": pivot_ws.Cells(17, 10), "width_cm": 5.09, "height_cm": 15.23},
    {"field": "Tag: Environment", "top_left_cell": pivot_ws.Cells(2, 5), "width_cm": 19.94, "height_cm": 4.42},
    {"field": "Tag: Dept", "top_left_cell": pivot_ws.Cells(2, 10), "width_cm": 5.14, "height_cm": 7.06}
]
